...
- Bound prerelease artifacts to the trusted workflow revision with a hash-locked build toolchain,
  deterministic rebuild and byte comparison, plus mandatory protected-environment review.
